...
`codex/vim-daily-parity`; worktree `.worktrees/vim-daily-parity`; start `2a8513f`

## Plan

- [x] Approve Vim daily-parity design; create `tesela-8c9v.4.16`.
- [x] User-review spec; write the phase execution plan.
