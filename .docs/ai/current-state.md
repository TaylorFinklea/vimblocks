...
## Branch
`main`; `v1.0.0-rc.1` published; local `rc.2` UI candidate; final unreleased.
Rollback: `codex/vim-daily-parity`, `codex/db-natural-capture`.
## Plan
Preparing v1.0.0-rc.2 for restarted device soak; final plan:
...
- [?] Awaiting human verify: rc.2 colors, highlighted tokens, editing/caret
...
Verify: check + 153 tests + package; then live capture screenshot/input.
## Blockers: none
## Open questions: none
