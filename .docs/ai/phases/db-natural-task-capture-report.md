...
- Shortcut: `mod+shift+space`; blank setting disables shortcut only
...
- Direct Computer Use: palette entry, shortcut, preview, create, cancel,
  ordinary palette Esc, and one enabled plugin card
