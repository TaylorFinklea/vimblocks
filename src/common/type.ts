...
export const keyBindingsMeta: KeyBindingMeta[] = [
  ...
  { key: 'lineStart', label: 'Line Start', description: 'Move to start of line', category: 'navigation', defaultBinding: '0' },
  { key: 'firstNonBlank', label: 'First Nonblank', description: 'Move to first nonblank character', category: 'navigation', defaultBinding: 'shift+6' },
  ...
  { key: 'top', label: 'Jump to Top', description: 'Jump to first rendered block', category: 'navigation', defaultBinding: 'g g' },
  ...
  { key: 'tillChar', label: 'Till Character', description: 'Move before a character in the current line', category: 'navigation', defaultBinding: 't' },
  { key: 'tillCharBackward', label: 'Till Character Backward', description: 'Move after a previous character in the current line', category: 'navigation', defaultBinding: 'shift+t' },
  ...
  { key: 'repeatChange', label: 'Repeat Change', description: 'Repeat the last Vim change', category: 'editing', defaultBinding: '.' },
  ...
  { key: 'changeInnerWord', label: 'Change Inner Word', description: 'Start ciw; press w to change the word at the cursor', category: 'editing', defaultBinding: 'c i' },
  { key: 'deleteInnerWord', label: 'Delete Inner Word', description: 'Start diw; press w to delete the word at the cursor', category: 'editing', defaultBinding: 'd i' },
  { key: 'yankInnerWord', label: 'Yank Inner Word', description: 'Start yiw; press w to yank the word at the cursor', category: 'editing', defaultBinding: 'y i' },
  { key: 'changeAroundWord', label: 'Change Around Word', description: 'Start caw; press w to change the word and adjacent whitespace', category: 'editing', defaultBinding: 'c a' },
  { key: 'deleteAroundWord', label: 'Delete Around Word', description: 'Start daw; press w to delete the word and adjacent whitespace', category: 'editing', defaultBinding: 'd a' },
  { key: 'yankAroundWord', label: 'Yank Around Word', description: 'Start yaw; press w to yank the word and adjacent whitespace', category: 'editing', defaultBinding: 'y a' },
  { key: 'changeWord', label: 'Change Word', description: 'Change through the current word end', category: 'editing', defaultBinding: 'c w' },
  { key: 'deleteWord', label: 'Delete Word', description: 'Delete to the next word start', category: 'editing', defaultBinding: 'd w' },
  { key: 'yankWord', label: 'Yank Word', description: 'Yank to the next word start', category: 'editing', defaultBinding: 'y w' },
  { key: 'changeWordEnd', label: 'Change to Word End', description: 'Change through the current word end', category: 'editing', defaultBinding: 'c e' },
  { key: 'deleteWordEnd', label: 'Delete to Word End', description: 'Delete through the current word end', category: 'editing', defaultBinding: 'd e' },
  { key: 'yankWordEnd', label: 'Yank to Word End', description: 'Yank through the current word end', category: 'editing', defaultBinding: 'y e' },
  { key: 'changeLineEnd', label: 'Change to Line End', description: 'Change from the cursor to line end', category: 'editing', defaultBinding: ['c shift+4', 'shift+c'] },
  { key: 'deleteLineEnd', label: 'Delete to Line End', description: 'Delete from the cursor to line end', category: 'editing', defaultBinding: ['d shift+4', 'shift+d'] },
  { key: 'yankLineEnd', label: 'Yank to Line End', description: 'Yank from the cursor to line end', category: 'editing', defaultBinding: 'y shift+4' },
  { key: 'changeLine', label: 'Change Line', description: 'Change the entire block content', category: 'editing', defaultBinding: ['c c', 'shift+s'] },
