...
export const keyBindingsMeta: KeyBindingMeta[] = [
  ...
  { key: 'top', label: 'Jump to Top', description: 'Jump to top of page; remap to g g after disabling Logseq graph-view binding', category: 'navigation', defaultBinding: 'shift+t' },
